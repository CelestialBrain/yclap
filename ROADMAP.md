...
| Polkadoc vault mining | App found at `~/Antigravity/polkadoc`; need vault data location/access |
| Messenger YCLAP groupchats | Need chat export or logged-in browser lane |
